...
const Header = () => {
	...
	return (
		<header className='full-height pt-80  valign to-up'>
								...
								<Typewriter
									...
									onInit={(typewriter) => {
										typewriter
											...
											.pauseFor(1000)
											.deleteAll()
											.typeString("Compasión")
											.pauseFor(1000)
											.deleteAll()
											.typeString("Determinación")
											.start();
									}}
								/>
							</h1>
								...
								<div>
									<Link href='/services-creative'>
										<a className='butn butn-md gr-purple2-bg text-light radius-30'>
											<span className='text slide-up'>Conócenos</span>
											<span className='text slide-down'>Empecemos</span>
										</a>
									</Link>
								</div>
							</div>

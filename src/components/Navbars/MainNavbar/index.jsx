		...
		<nav className={`navbar navbar-expand-lg ${theme}`} ref={navbarRef}>
			<div className='container'>
				<Link className='navbar-brand' href='/'>
					<div className='logo'>
						{logoTheme === "dark" && <img style={{ width: 200 }} src='img/3MPATHY_LOGO.png' alt='' />}
						{logoTheme === "light" && <img style={{ width: 200 }} src='img/3MPATHY_LOGO.png' alt='' />}
						{!logoTheme && <img style={{ width: 200 }} src='img/3MPATHY_LOGO.png' alt='' />}
					</div>
				</Link>
									...
									<ul className='dropdown-side'>
										<li>
											<Link href='/services-creative'>
												<a className='dropdown-item'>Services Creative</a>
											</Link>
										</li>
										<li>
											<Link href='/services-business'>
												<a className='dropdown-item'>Services Business</a>
											</Link>
										</li>
										<li>
											<Link href='/services-corporate'>
												<a className='dropdown-item'>Services Corporate</a>
											</Link>
										</li>
									</ul>
								</li>
